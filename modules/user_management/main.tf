...
module "lambda" {
  ...
  list_all_users_filename = "${path.module}/lambda_functions/admin/list_all_users.zip"
  assign_admin_role_filename = "${path.module}/lambda_functions/admin/assign_admin_role.zip"
  revoke_admin_role_filename = "${path.module}/lambda_functions/admin/revoke_admin_role.zip"
